  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
      ...
      <div
        ...
        className="bg-white dark:bg-[#151518] rounded-3xl p-5 border border-gray-200/80 dark:border-neutral-800 shadow-2xs hover:border-black dark:hover:border-neutral-600 transition-all cursor-pointer group flex flex-col justify-between"
      >
