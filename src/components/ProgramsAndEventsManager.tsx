...
export const ProgramsAndEventsManager: React.FC<ProgramsAndEventsManagerProps> = ({
  ...
  const handleOpenEditEvent = (evt: CronogramaEvent) => {
    ...
    setEventFormData({
      ...
      googleFormsUrl: evt.googleFormsUrl || 'https://forms.gle/5Hiuxwq13n3gC3zt6',
      googleSheetsUrl: evt.googleSheetsUrl || 'https://docs.google.com/spreadsheets/d/1DyKs4OsJDTTOa8SMSvOQdWcttrmRKJ8_vxnJH9rV5UA/edit?usp=sharing',
      googleDriveFolderUrl: evt.googleDriveFolderUrl || 'https://drive.google.com/drive/folders/15laHG-2cFXvLiVoLp6GxJBWIBdXLB6bz?usp=drive_link',
