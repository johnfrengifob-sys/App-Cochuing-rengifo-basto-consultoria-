      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 p-3 bg-white dark:bg-[#18181B] border border-gray-200/80 dark:border-neutral-800 rounded-2xl shadow-2xs">
            ...
            <div className="flex items-center gap-1 border-l border-gray-200 dark:border-neutral-800 pl-2">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-xs font-medium cursor-pointer transition-colors ${
                  statusFilter === 'all'
                    ? 'bg-white dark:bg-neutral-700 text-neutral-900 dark:text-white font-bold border border-gray-300 dark:border-neutral-600 shadow-2xs'
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white border border-emerald-500/40 hover:bg-emerald-50/50 dark:hover:bg-emerald-950/30 hover:border-emerald-500 text-xs font-semibold flex items-center gap-1.5 cursor-pointer shadow-xs transition-all"
          >
          ...
          <div className="bg-white dark:bg-[#18181B] rounded-3xl max-w-md w-full p-6 border border-gray-100 dark:border-neutral-800 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleCreateClient} className="space-y-3 text-xs">
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-semibold transition-all shadow-xs cursor-pointer"
                >
                  Crear Coachee
                </button>
              </div>
